...
$(document).ready(function(){
	$(function(){
		$.ajax({
			url:'${pageContext.request.contextPath}/FranchiseListServlet',
			dataType:'json',
			...
			listArray = result;			
				if(listArray.length > 0){
					for(var i = 0 ; i < listArray.length ; i ++){
						var tdRow = "<tr>"+header+
							"<td id='fNumber_"+listArray[i].fNumber+"'>"+listArray[i].fNumber+"</td>"
							+"<td id='fName_"+listArray[i].fNumber+"'>"+listArray[i].fName+"</td>"
							+"<td id='fEmail_"+listArray[i].fNumber+"'>"+listArray[i].fEmail+"</td>"
							+"<td id='fAge_"+listArray[i].fNumber+"'>"+listArray[i].fAge+"</td>"
							+"<td id='fTel_"+listArray[i].fNumber+"'>"+listArray[i].fTel+"</td>"
							+"<td id='fAddress_+"+listArray[i].fNumber+"'>"+listArray[i].fAddress+"</td>"
							+"<td id='fContent_+"+listArray[i].fNumber+"'>"+listArray[i].fContent+"</td>"
							+"<td>"
