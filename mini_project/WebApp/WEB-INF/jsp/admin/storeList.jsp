...
function updateFunc(){
	...
	var imageName = $("#file2").val();
		...
		updatefrm.action="storefileUploadUp.do";
		//submitFrm.submit();
	return true;
}
...
$(document).ready(function(){
	$(function(){
		$.ajax({
			url:'${pageContext.request.contextPath}/StoreListServlet',
			dataType:'json',
			...
			listArray = result;			
				if(listArray.length > 0){
					for(var i = 0 ; i < listArray.length ; i ++){
						var tdRow = "<tr>"+header+
							"<td id='sNumber_"+listArray[i].sNumber+"'>"+listArray[i].sNumber+"</td>"
							+"<td id='sName_"+listArray[i].sNumber+"'>"+listArray[i].sName+"</td>"
							+"<td id='sTel_"+listArray[i].sNumber+"'>"+listArray[i].sTel+"</td>"
							+"<td id='sAddress_"+listArray[i].sNumber+"'>"+listArray[i].sAddress+"</td>"
							+"<td id='sContent_"+listArray[i].sNumber+"'>"+listArray[i].sContent+"</td>"
							+"<td id='sImage_"+listArray[i].sNumber+"'>"+listArray[i].sImage+"</td>"
							+"<td>"
								+'<a href="#editStoreModal" id="btnEditModal_'+listArray[i].sNumber+'"class="edit" data-toggle="modal">'
								+'<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;'+'</i>'+'</a>'
								+'<a href="#deleteStoreModal" id="btnDelModal_'+listArray[i].sNumber+'"class="delete" data-toggle="modal" onclick="clickFunc(event)">'
					...
					$(".edit").bind("click",function(){
						...
						/* console.log(idx); */
							...
							$("#editStoreModal").find('#edit_sImage').val($('#sImage_'+idx).text());
					});
...
<div id="addStoreModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form name="submitFrm" action="storefileUpload.do" method="post" enctype="multipart/form-data" onsubmit="submitFunc()">
...
<div id="editStoreModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="container" name="updatefrm" method="post" enctype="multipart/form-data" onsubmit="return updateFunc()">
				<div class="modal-header">						
