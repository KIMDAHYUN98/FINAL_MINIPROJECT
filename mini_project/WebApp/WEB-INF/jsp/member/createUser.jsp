	...
	function idCheck(str) {
		...
		if (str == "") {
			...
			window.open(url, "아이디 중복 체크",
					"width=500, height=155, top=100, left=100");
		}
	}
		...
		<article class="card-body mx-auto" style="max-width: 400px;">
			...
			<form id="frm" name="frm" class="form-text" action="memberInsert.do" method="post" onsubmit="return formCheck()">
				...
				<div class="form-group input-group">
					...
					<input type="text" id="sample6_postcode" name="mPostcode" placeholder="우편번호" class="form-control">
				...
				<div class="form-group input-group">
					...
					<input type="text" id="sample6_detailAddress" name="mDetailAdr" placeholder="상세주소" class="form-control">
				</div>
				<!-- 생년월일 입력 -->
				<div class="form-group input-group">
					<div class="input-group-prepend">
					...
					<input name="mBirth" id="mBirth" class="form-control" placeholder="생년월일" type="date" required="required">
				</div>
				<!-- form-group End -->
