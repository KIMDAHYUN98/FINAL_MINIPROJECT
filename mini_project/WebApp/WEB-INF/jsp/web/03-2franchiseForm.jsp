	...
	<div class="col-md-6">
		...
		<form id="frm" name="frm" action="franchiseInsert.do" method="post">
			...
			<div class="control-group">
				<input  type="text" class="form-control" id="fName" name="fName" placeholder="이름" required="required" value="${name }"/>
				<p class="help-block text-danger"></p>
				<input type="text" class="form-control" id="fEmail" name="fEmail" placeholder="Email" required="required" value="${email }"/>
				<p class="help-block text-danger"></p>
				<input type="text" class="form-control" id="fTel" name="fTel" placeholder="연락처" required="required" value="${tel }"/>
				<p class="help-block text-danger"></p>
